                                    ...
                                    <div class="navbar-footer-content">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xs-6">
                                              ...
                                              <a href="javascript:void(0)" id="logout" class="btn btn-default btn-sm pull-right">Sign Out</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form">
                                    <form class="form-horizontal" id="frm_change_password">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                            	<div class="input-icon"><i class="fa fa-key"></i> <input id="confirm_password" name="password_confirmation" type="password" placeholder="Confirm New Password" class="form-control"/><span class="text-10px">(Password length should be between 6-12 characters)</span>  
        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="{{url('/web88/admin')}}"><i class="fa fa-laptop fa-fw"></i><span class="menu-title">Dashboard</span></a></li>
                    <li class="sidebar-heading"><h4>Clients</h4></li>
                    
                    <li><a href="{{url('/clients')}}"><i class="fa fa-user fa-fw"></i><span class="menu-title">Clients Listing</span></a></li>
                  ...
                  <li><a href="billing_quote_new.html"><i class="fa fa-plus fa-fw"></i><span class="menu-title">Add New Quote</span></a></li>
                    ...
                    <li><a href="#"><i class="fa fa-globe fa-fw"></i><span class="menu-title">Domains</span><span class="fa arrow"></span></a>
                      <ul class="nav nav-second-level">
                          <li><a href="single_domain_prices_list.html">Single Domain Pricing List</a></li>
						  <li><a href="bulk_domain_prices_list.html">Bulk Domain Pricing List</a></li>
                          <li><a href="domain_addons_prices_list.html">Domain Addons Pricing List</a></li>
                      </ul>
                  	</li> 
